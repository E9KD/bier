        ...
        <div class="cf-bg" style="z-index:999;" v-if="isDefault">
            ...
            <div class='jz' style='width:100vw;height:1005;'>
                <div class='jz' style='width:80vw;height:100vh;padding-top:10vh;'>
                    <div style='width:100%;height:64vh;border:1px solid #fff;border-radius:5px;position:relative;background:#fff'>
                        <div style='width:100%;height:28px;'>
                            <div style='width:30px;height:30px;line-height:30px;margin:0 auto;float:right;font-size:16px;text-align:center;' @click='CloseDefault'>X</div>
                        </div>
                        <!-- 查询 300 1500 -->
                        <!-- 头部三部分 -->
                        ...
                        <!-- 底部 -->
                        <div style='width:100%;background:#e5e5e5;overflow:hidden;position:absolute;bottom:0;box-sizing:border-box;'>
                            <div style='background:#e5e5e5;'>
                                <!-- 底部 -->
                                <button class='share' open-type="share" plain='true' style='width:50%;height:40px;float:left;line-height:40px;border:none'>转发</button>
                                <div style='width:50%;height:40px;float:right;line-height:40px;' @click='SaveCanvas'>保存</div>
                            </div>
                        </div>
                    </div>
                </div>
