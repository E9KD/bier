  ...
  <div class="writemsg">
    <div class="box">
      ...
      <form bindsubmit="formSubmit" bindreset="formReset">
        ...
        <div class="shuru">
          <textarea class="shuru1" v-model="keyWord" placeholder="这一刻的想法" placeholder-style="font-size:12pt;color:#E4E3E3" name="content" />
        </div>
        ...
        <div class="images-wrapper">
          ...
          <div class="images-list">
            ...
            <div class="images-image image-plus" @click="ChooseImage" :style="{display:imgLength==9 ? 'none' :'div'}">
