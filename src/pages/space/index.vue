          ...
          <div class="right_box">
              ...
              <div class="images-wrapper">
                <div class="images-list">
                  ...
                  >
                    <img
                      class="images-image1"
                      :src="'https://wx.biergao.vip/uploads/thumb' + item2"
                      @click="PreviewImage(item2,item.imglist)"
                    >
                  </div>
                </div>
              </div>
            ...
            <div class="time">
              ...
              <div v-if="item.dianzan" style="float:right;overflow:hidden">
                ...
                <div
                  style="display:inline-block;vertical-align: middle;font-size:30rpx;margin-left:10rpx;"
                >已赞</div>
              </div>
              ...
              <div
                ...
                @click="UpStar(item.id,item.dianzan,index)"
              >
