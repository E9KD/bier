        ...
        <div class="bottom_box" v-for="(item,index) in list0" :key="index">
          <div class="box_container">
            ...
            <div class="box_bottom">
              ...
              <img
                :src="item.heightList?showimg:hideimg"
                alt
                class="arrow"
                @click="ChangeArrowState(index,list0)"
              >
            </div>
          </div>
        </div>
          ...
          <div class="box_container">
            ...
            <div class="box_bottom">
              ...
              <img
                ...
                alt
                class="arrow"
                @click="ChangeArrowState(index,list1)"
              >
            </div>
          </div>
        </div>
          ...
          <div class="box_container">
            ...
            <div class="box_bottom">
              ...
              <img
                ...
                alt
                class="arrow"
                @click="ChangeArrowState(index,list2)"
              >
            </div>
          </div>
        </div>
          ...
          <div class="box_container">
            ...
            <div class="box_bottom">
              ...
              <img
                ...
                alt
                class="arrow"
                @click="ChangeArrowState(index,list3)"
              >
            </div>
          </div>
        </div>
          ...
          <div class="box_container">
            ...
            <div class="box_bottom">
              ...
              <img
                ...
                alt
                class="arrow"
                @click="ChangeArrowState(index,list4)"
              >
            </div>
          </div>
        </div>
          ...
          <div class="box_container">
            ...
            <div class="box_bottom">
              ...
              <img
                ...
                alt
                class="arrow"
                @click="ChangeArrowState(index,list5)"
              >
            </div>
          </div>
        </div>
          ...
          <div class="box_container">
            ...
            <div class="box_bottom">
              ...
              <img
                ...
                alt
                class="arrow"
                @click="ChangeArrowState(index,list6)"
              >
            </div>
          </div>
        </div>
          ...
          <div class="box_container">
            ...
            <div class="box_bottom">
              ...
              <img
                ...
                alt
                class="arrow"
                @click="ChangeArrowState(index,list7)"
              >
            </div>
          </div>
        </div>
    ...
    ComputeScore(res) {
      ...
      if (this.globalScore.assess1 >= 6) {
        (this.list0[0].title = res.data[1 - 1].assess_a),
          ...
          (this.list0[0].content = res.data[1 - 1].pingfenzhibiao.assess_a
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
        ...
        (this.list0[0].title = res.data[1 - 1].assess_b),
          ...
          (this.list0[0].content = res.data[1 - 1].pingfenzhibiao.assess_b
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      } else {
        (this.list0[0].title = res.data[1 - 1].assess_c),
          (this.list0[0].type = res.data[1 - 1].type3),
          (this.list0[0].content = res.data[1 - 1].pingfenzhibiao.assess_c
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      }
      ...
      if (this.globalScore.assess2 >= 70) {
        (this.list1[0].title = res.data[2 - 1].assess_a),
          ...
          (this.list1[0].content = res.data[2 - 1].pingfenzhibiao.assess_a
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      } else if (
        ...
        (this.list1[0].title = res.data[2 - 1].assess_b),
          ...
          (this.list1[0].content = res.data[2 - 1].pingfenzhibiao.assess_b
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      } else {
        (this.list1[0].title = res.data[2 - 1].assess_c),
          (this.list1[0].type = res.data[2 - 1].type3),
          (this.list1[0].content = res.data[2 - 1].pingfenzhibiao.assess_c
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      }
      ...
      if (this.globalScore.assess3 >= 28) {
        (this.list2[0].title = res.data[3 - 1].assess_a),
          ...
          (this.list2[0].content = res.data[3 - 1].pingfenzhibiao.assess_a
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      } else if (
        ...
        (this.list2[0].title = res.data[3 - 1].assess_b),
          ...
          (this.list2[0].content = res.data[3 - 1].pingfenzhibiao.assess_b
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      } else {
        (this.list2[0].title = res.data[3 - 1].assess_c),
          (this.list2[0].type = res.data[3 - 1].type3),
          (this.list2[0].content = res.data[3 - 1].pingfenzhibiao.assess_c
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      }
      ...
      if (this.globalScore.assess4 >= 13) {
        (this.list3[0].title = res.data[3 - 1].assess_a),
          ...
          (this.list3[0].content = res.data[3 - 1].pingfenzhibiao.assess_a
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      } else if (
        ...
        (this.list3[0].title = res.data[3 - 1].assess_b),
          ...
          (this.list3[0].content = res.data[3 - 1].pingfenzhibiao.assess_b
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      } else {
        (this.list3[0].title = res.data[3 - 1].assess_c),
          (this.list3[0].type = res.data[3 - 1].type3),
          (this.list3[0].content = res.data[3 - 1].pingfenzhibiao.assess_c
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      }
      ...
      if (this.globalScore.assess5 >= 38) {
        (this.list4[0].title = res.data[5 - 1].assess_a),
          ...
          (this.list4[0].content = res.data[5 - 1].pingfenzhibiao.assess_a
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      } else if (
        ...
        (this.list4[0].title = res.data[5 - 1].assess_b),
          ...
          (this.list4[0].content = res.data[5 - 1].pingfenzhibiao.assess_b
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      } else {
        (this.list4[0].title = res.data[5 - 1].assess_c),
          (this.list4[0].type = res.data[5 - 1].type3),
          (this.list4[0].content = res.data[5 - 1].pingfenzhibiao.assess_c
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      }
      ...
      if (this.globalScore.assess6 >= 17) {
        (this.list5[0].title = res.data[6 - 1].assess_a),
          ...
          (this.list5[0].content = res.data[6 - 1].pingfenzhibiao.assess_a
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      } else if (
        ...
        (this.list5[0].title = res.data[6 - 1].assess_b),
          ...
          (this.list5[0].content = res.data[6 - 1].pingfenzhibiao.assess_b
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      } else {
        (this.list5[0].title = res.data[6 - 1].assess_c),
          (this.list5[0].type = res.data[6 - 1].type3),
          (this.list5[0].content = res.data[6 - 1].pingfenzhibiao.assess_c
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      }
      ...
      if (this.globalScore.assess7 >= 8) {
        (this.list6[0].title = res.data[7 - 1].assess_a),
          ...
          (this.list6[0].content = res.data[7 - 1].pingfenzhibiao.assess_a
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
        ...
        (this.list6[0].title = res.data[7 - 1].assess_b),
          ...
          (this.list6[0].content = res.data[7 - 1].pingfenzhibiao.assess_b
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      } else {
        (this.list6[0].title = res.data[7 - 1].assess_c),
          (this.list6[0].type = res.data[7 - 1].type3),
          (this.list6[0].content = res.data[7 - 1].pingfenzhibiao.assess_c
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      }
      ...
      if (this.globalScore.assess8 >= 10) {
        (this.list7[0].title = res.data[8 - 1].assess_a),
          ...
          (this.list7[0].content = res.data[8 - 1].pingfenzhibiao.assess_a
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      } else if (
        ...
        (this.list7[0].title = res.data[8 - 1].assess_b),
          ...
          (this.list7[0].content = res.data[8 - 1].pingfenzhibiao.assess_b
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      } else {
        (this.list7[0].title = res.data[8 - 1].assess_c),
          (this.list7[0].type = res.data[8 - 1].type3),
          (this.list7[0].content = res.data[8 - 1].pingfenzhibiao.assess_c
            .replace(/16/g, "12")
            .replace(/pt/g, "px"));
      }
      console.log(`执行了列表`);
