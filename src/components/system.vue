...
import { mapMutations } from 'vuex';
    export default {
        ...
        methods: {
            ...
            asd(){
                this.ChangePolarParam(this.list2)
                wx.navigateTo({
